      ...
      <div className="chat-panel__header">
        ...
        <div className="chat-panel__header-actions">
          <button
            ...
            aria-label="Toggle full document context"
          >
            <svg width="13" height="13" viewBox="0 0 13 13" fill="none" aria-hidden="true">
              <path d="M2.5 1.5H7.5L10.5 4.5V11.5H2.5V1.5Z" stroke="currentColor" strokeWidth="1.1"/>
              <path d="M7.5 1.5V4.5H10.5" stroke="currentColor" strokeWidth="1.1"/>
              <line x1="4.5" y1="6.5" x2="8.5" y2="6.5" stroke="currentColor" strokeWidth="1" strokeLinecap="round"/>
              <line x1="4.5" y1="8.5" x2="8.5" y2="8.5" stroke="currentColor" strokeWidth="1" strokeLinecap="round"/>
            </svg>
          </button>
          <button
